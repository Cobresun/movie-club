...
export async function up(db: Kysely<unknown>) {
  ...
  await db.schema
    ...
    .addForeignKeyConstraint("fk_work_club_id", ["club_id"], "club", ["id"], (cb) =>
      cb.onDelete("cascade"),
    )
  ...
  await db.schema
    ...
    .addColumn("id", "serial", (col) => col.primaryKey())
    .addColumn("club_id", "int8", (col) => col.notNull())
    .addForeignKeyConstraint("fk_work_list_club_id", ["club_id"], "club", ["id"], (cb) =>
      cb.onDelete("cascade"),
    )
  ...
  await db.schema
    ...
    .addForeignKeyConstraint("fk_work_list_item_list_id", ["list_id"], "work_list", ["id"], (cb) =>
      cb.onDelete("cascade"),
    )
    .addForeignKeyConstraint("fk_work_list_item_work_id", ["work_id"], "work", ["id"], (cb) =>
