<template>
  <div>
    ...
    <v-modal v-if="showInviteModal" size="sm" @close="showInviteModal = false">
      ...
      <div class="space-y-3">
        <p class="pb-4 text-sm text-gray-500">Share this link to invite people to your club</p>
    ...
    <div class="mx-auto flex max-w-5xl flex-wrap justify-center gap-3 px-4 pb-6">
